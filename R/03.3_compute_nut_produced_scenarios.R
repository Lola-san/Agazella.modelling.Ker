  ...
  input_tib_with_scenarios |>
    dplyr::mutate(# scenario 100%
      ...
      release_nut_ind_daily_scenario70 = seq_along(release_dm_ind_daily) |>
        purrr::map(~ purrr::pluck(release_dm_ind_daily, ., 1) * purrr::pluck(scat_boot_scenario70, .)), 
      ...
      release_nut_ind_daily_scenario60 = seq_along(release_dm_ind_daily) |>
        purrr::map(~ purrr::pluck(release_dm_ind_daily, ., 1) * purrr::pluck(scat_boot_scenario60, .)), 
      ...
      release_nut_ind_daily_scenario50 = seq_along(release_dm_ind_daily) |>
        purrr::map(~ purrr::pluck(release_dm_ind_daily, ., 1) * purrr::pluck(scat_boot_scenario50, .)), 
      ...
      release_nut_ind_daily_scenario40 = seq_along(release_dm_ind_daily) |>
        purrr::map(~ purrr::pluck(release_dm_ind_daily, ., 1) * purrr::pluck(scat_boot_scenario40, .)), 
      ...
      release_nut_ind_daily_scenario30 = seq_along(release_dm_ind_daily) |>
        purrr::map(~ purrr::pluck(release_dm_ind_daily, ., 1) * purrr::pluck(scat_boot_scenario30, .)), 
      ...
      release_nut_ind_daily_scenario20 = seq_along(release_dm_ind_daily) |>
        purrr::map(~ purrr::pluck(release_dm_ind_daily, ., 1) * purrr::pluck(scat_boot_scenario20, .)), 
      ...
      release_nut_ind_daily_scenario10 = seq_along(release_dm_ind_daily) |>
        purrr::map(~ purrr::pluck(release_dm_ind_daily, ., 1) * purrr::pluck(scat_boot_scenario10, .)), 
      ...
      release_nut_ind_daily_scenario00 = seq_along(release_dm_ind_daily) |>
        purrr::map(~ purrr::pluck(release_dm_ind_daily, ., 1) * purrr::pluck(scat_boot_scenario00, .)), 
