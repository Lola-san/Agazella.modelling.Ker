...
list(
 ...
 tar_target(percent_cluster_with_scenarios_PS_clust3,
  ...
  # script 03.5_compute_nut_produced_scenarios.R
 # first CAP NOIR
 ...
 tar_target(table_test_nut_release_with_all_scenarios_CN,
            MWtest_test_nut_sites_tot_period_all_scenarios(list(output_nut_release_with_scenarios_CN_clust1,
                                                       ...
                                                       output_nut_release_with_scenarios_CN_clust3),
                                                  site = "Cap Noir")),
 tar_target(table_differences_mean_nut_release_with_scenarios_clust1_CN,
            percent_diff_nut_sites_tot_period_1_scenarios(output_nut_release_with_scenarios_CN_clust1,
                                                          clust_test = 1,
                                                          site = "Cap Noir")),
 tar_target(table_differences_mean_nut_release_with_scenarios_clust2_CN,
            percent_diff_nut_sites_tot_period_1_scenarios(output_nut_release_with_scenarios_CN_clust2,
                                                          clust_test = 2,
                                                          site = "Cap Noir")),
 tar_target(table_differences_mean_nut_release_with_scenarios_clust3_CN,
            percent_diff_nut_sites_tot_period_1_scenarios(output_nut_release_with_scenarios_CN_clust3,
                                                          clust_test = 3,
                                                          site = "Cap Noir")),
 tar_target(table_differences_mean_nut_release_with_all_scenarios_CN,
            compile_percent_diff_nut_sites_tot_period_scenarios(
              list(table_differences_mean_nut_release_with_scenarios_clust1_CN,
                   table_differences_mean_nut_release_with_scenarios_clust2_CN,
                   table_differences_mean_nut_release_with_scenarios_clust3_CN),
              site = "Cap Noir")),
